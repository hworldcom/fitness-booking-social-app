...
| Preview plan and gym discovery                            | Completed [DEV0074 — Preview multi-gym discovery](../../archive/frontend/DEV0074-preview-multigym-discovery.md)                      | Typed frontend read contracts, seven fictional participating-gym fixtures, plan comparison and responsive gym discovery/detail presentation                           | Delivered; COR0006 persistence later replaces the preview adapter                            |
...
DEV0069 and DEV0070 freeze the current target and initial demo economics. DEV0072 removed the obsolete product surfaces, DEV0073 delivered the public explanation plus the €15 non-core amendment, and DEV0074 delivered typed preview discovery. DEV0075 can now use the completed contracts and terminology to demonstrate the four-gym selection as a browser-local draft that stops before payment or activation.
...
- 2026-09-25: DEV0072–DEV0075 split the frontend-first delivery into legacy removal, public story, preview discovery and preview membership selection. DEV0072 and DEV0073 completed first; none of these preview tickets claims persistent membership or payment behavior.
- 2026-09-26: DEV0074 completed the versioned plan contracts and seven-gym preview. DEV0075 is now ready and remains the next frontend slice.
...
- Direct development tickets: DEV0069 Completed; DEV0070 Completed; DEV0072 Completed; DEV0073 Completed; DEV0076 Completed; DEV0074 Completed; DEV0075 Ready; DEV0023 Draft; four required implementation peers not yet created.
