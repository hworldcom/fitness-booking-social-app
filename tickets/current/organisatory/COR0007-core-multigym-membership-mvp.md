...
| Public product story | [DEV0073 — Rewrite the multi-gym public story](../frontend/DEV0073-rewrite-multigym-public-story.md) | Rewrite Home, metadata and How it works around the focused multi-gym product, its current demo economics and provisional allocation | Ready after completed DEV0072 removed overlapping legacy guide code |
...
DEV0069 and DEV0070 freeze the current target and demo economics. DEV0072 first removes the obsolete product surfaces. DEV0073 and DEV0074 may then proceed in parallel: one owns the public explanation and the other owns typed preview discovery. DEV0075 follows both and demonstrates the four-gym selection as a browser-local draft that stops before payment or activation.
...
- 2026-09-25: DEV0072–DEV0075 split the frontend-first delivery into legacy removal, public story, preview discovery and preview membership selection. DEV0072 completed the truthful baseline; DEV0073 and DEV0074 are ready, while DEV0075 remains blocked on both. None claims persistent membership or payment behavior.
...
- Direct development tickets: DEV0069 Completed; DEV0070 Completed; DEV0072 Completed; DEV0073 Ready; DEV0074 Ready; DEV0075 Blocked; DEV0023 Draft; four required implementation peers not yet created.
