...
- [ ] AC3: Database artifacts, connection modules and table mappings belong to DEV0015; feature repositories belong to their capability tickets; backend-boundary enforcement belongs to DEV0025. Real server modules follow the documented service/repository direction and no privileged dependency enters a client bundle.
