...
| ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [DEV0016 — Phantom authentication and demo access](../backend/DEV0016-phantom-auth-and-demo-access.md)     | Uses DEV0015/DEV0025 boundaries and DEV0027's account; owns identity/access repositories plus verified transaction context.                     |
...
DEV0015 and DEV0025 completed together with distinct ownership. DEV0015 created database artifacts, environment/connection modules and Drizzle table mappings. DEV0025 created and validated server-only dependency enforcement around them. DEV0015 deliberately created no feature repository: DEV0016 owns identity/access repositories and transaction context; DEV0017 owns catalogue/profile/draft/follow/bookmark repositories; DEV0018, DEV0023 and later capability tickets own their respective repositories. DEV0027 establishes browser-safe Solana connection modules. Separate future tickets must establish trusted server-Solana verification and the Anchor workspace/generated-client contract.
...
3. Apply database foundation ownership through DEV0015: `supabase` contains the sole schema history/policies/seeds and `src/server/db` gains only validated environment/connection modules plus Drizzle table mappings. Add repositories later through their owning capability tickets, beginning with DEV0016/DEV0017.
