...
| [Search route](../../../src/app/search/page.tsx), [discovery helpers](../../../src/lib/discovery.ts)                                                  | Public-only grouped search, normalized multiword matching, challenge filtering/ordering and deterministic related links.                           |
| [Fixtures](../../../src/lib/fixtures.ts), [challenge route](../../../src/app/challenges/page.tsx)                                                     | Explicit start/end/creation dates and optional venue association; safe query/mode parameters and guide deep links.                                 |
