...
- [DEV0015](../../current/backend/DEV0015-supabase-database-foundation.md): scoped local database tooling, base schema, restricted roles, migrations and reproducible seeds.
