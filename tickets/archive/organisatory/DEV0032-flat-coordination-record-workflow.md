...
- [Tickets DEV0030](../frontend/DEV0030-frontend-screen-module-boundaries.md) and [DEV0031](../../current/frontend/DEV0031-preview-data-and-domain-boundaries.md) now link to Coordination 0028 as direct peer development tickets. The [repository README](../../../README.md), [MVP specification](../../../docs/mvp-spec.md) and affected historical 0029 links use the renamed path and record type.
